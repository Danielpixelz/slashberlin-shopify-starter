...
app.get('/api/shopify', passportConfig.isAuthenticated, apiController.getShopify);
app.post('/api/shopify', passportConfig.isAuthenticated,  apiController.postShopifyProduct);
